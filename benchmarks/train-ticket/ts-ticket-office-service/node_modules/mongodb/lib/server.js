 ...
 * @class
 * @deprecated
 * @param {string} host The host for the server, can be either an IP4, IP6 or entity socket style host.
 ...
 * @param {boolean} [options.domainsEnabled=false] Enable the wrapping of the callback in the current entity, disabled by default to avoid perf hit.
