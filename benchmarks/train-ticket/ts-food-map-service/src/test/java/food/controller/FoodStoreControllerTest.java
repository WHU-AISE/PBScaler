...
public class FoodStoreControllerTest {
    ...
    public void setUp() {
        ...
        mockMvc = MockMvcBuilders.standaloneSetup(foodStoreController).build();
    }
    ...
    public void testGetAllFoodStores() throws Exception {
        Mockito.when(foodMapService.listFoodStores(Mockito.any(HttpHeaders.class))).thenReturn(response);
    ...
    public void testGetFoodStoresOfStation() throws Exception {
        Mockito.when(foodMapService.listFoodStoresByStationId(Mockito.anyString(), Mockito.any(HttpHeaders.class))).thenReturn(response);
    ...
    public void testGetFoodStoresByStationIds() throws Exception {
        ...
        Mockito.when(foodMapService.getFoodStoresByStationIds(Mockito.anyList())).thenReturn(response);
